...
public class ActivityUtils {
    ...
    public static boolean isActivityExists(String packageName, String className) {
        ...
        return !(App.INSTANCE.getPackageManager().resolveActivity(intent, 0) == null ||
                intent.resolveActivity(App.INSTANCE.getPackageManager()) == null ||
                App.INSTANCE.getPackageManager().queryIntentActivities(intent, 0).size() == 0);
    }
    ...
    public static void launchActivity(String packageName, String className, Bundle bundle) {
        App.INSTANCE.startActivity(IntentUtils.getComponentIntent(packageName, className, bundle));
    }
