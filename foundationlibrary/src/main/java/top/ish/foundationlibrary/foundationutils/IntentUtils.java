...
public class IntentUtils {
    ...
    public static Intent getInstallAppIntent(File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            Uri contentUri = FileProvider.getUriForFile(App.INSTANCE, "com.your.package.fileProvider", file);
    ...
    public static Intent getLaunchAppIntent(String packageName) {
        return App.INSTANCE.getPackageManager().getLaunchIntentForPackage(packageName);
    }
