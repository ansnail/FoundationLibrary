...
public class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            App.INSTANCE.startActivity(new Intent(android.provider.Settings.ACTION_WIRELESS_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        } else {
            App.INSTANCE.startActivity(new Intent(android.provider.Settings.ACTION_SETTINGS).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
        }
    }
    ...
    private static NetworkInfo getActiveNetworkInfo() {
        return ((ConnectivityManager) App.INSTANCE.getSystemService(Context.CONNECTIVITY_SERVICE)).getActiveNetworkInfo();
    }
    ...
    public static String getCurrentAPSSID(){
        WifiInfo info = getConnectionWifiInfo();
        if (null == info){
            return "";
        }
    ...
    public static boolean isAvailableByPing() {
        ShellUtils.CommandResult result = ShellUtils.execCmd("ping -c 1 -w 1 61.135.169.125", false);
    ...
    public static boolean isWifiAvailable() {
        return isWifiConnected() && isAvailableByPing();
    }
