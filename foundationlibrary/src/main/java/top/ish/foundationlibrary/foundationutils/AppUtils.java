...
public class AppUtils {
    ...
    public String getPackageNameFromPath(String path) {
        ...
        if (info != null) {
            ...
            result = appInfo.packageName;  //获取安装包名称
        }
        return result;
    }
    ...
    public static boolean installAppSilent(String filePath) {
        ...
        ShellUtils.CommandResult commandResult = ShellUtils.execCmd(command, !isSystemApp(App.INSTANCE), true);
    ...
    public static void launchApp(String packageName) {
        if (StringUtils.isSpace(packageName)) return;
        App.INSTANCE.startActivity(IntentUtils.getLaunchAppIntent(packageName));
    }
...
//        String packagePath = ai.sourceDir;
        ...
        return new AppInfo(packageName, name, null, null, versionName, versionCode);
    }
